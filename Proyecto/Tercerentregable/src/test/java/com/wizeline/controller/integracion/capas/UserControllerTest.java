package com.wizeline.controller.integracion.capas;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.gson.Gson;
import com.wizeline.controller.UserController;
...
public class UserControllerTest {
    ...
    public void DadoElServicioCrearUsuario_CuandoTieneBodyNulo_RegresaRespuestaGeneralErroneaControlada() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/login")
                ...
                //Se comenta el siguiente codigo, ya que solo se comnpara esto, cuando el cuerpo no es nulo
                //.andExpect(jsonPath("$.message").value("Required request parameter 'usuario' for method parameter type String is not present" ))
                .andReturn();
    ...
    public void DadoElServicioLogin_CuandoIngresaUsuarioYContrasenia_BuscaEnBDExistencia() throws Exception {
        ...
        UsuarioEntidad nuevoUsuarioEntidad = new UsuarioEntidad();
        ...
        log.info("Se arma un mapa para introducir los parametros requeridos en la peticion");
        LinkedMultiValueMap<String, String> requestParams = new LinkedMultiValueMap<>();
        requestParams.add("usuario", "k5");
        requestParams.add("contrasenia", "iop");
    ...
    @Test
    @DisplayName("Edge Case - LoginController - ValidaParametrosNulosOVacios")
    public void DadoElServicioLogin_SiRecibeLosParametrosVaciosoNulos_RegresaBadRequest() throws Exception {
        log.info("Se inicializan los parametros de entrada, ya sean nulos o simplemente vacios");
        //Cambiar valor de idUsuario y nuevaContrasenia a valores como: "" o null
        //En caso de poner valor null, no imprime el ultimo log, ya que truena por tipo: MissingServletRequestParameterException
        String usuario = "";
        String contrasenia = "";
    ...
    public void DadoElServicioLogin_SiRecibeLosParametrosDeUsuarioNoValido_RegresaRespuestaGeneralControlada() throws Exception {
        ...
        log.info("Se mockea el servicio que será llamado para que conteste con una peticion mala esperada");
        Mockito.when(userService.loginService(usuario, contrasenia)).thenReturn(new ResponseEntity<>(dto, HttpStatus.BAD_REQUEST));
        ...
        log.info("MvcResult login de usuario invalido: "+result.getResponse().getContentAsString());
    }

    /* Prueba unitaria de cada endpoint de la API - Obtener Usuarios */
    @Test
    @DisplayName("Obtener Usuarios")
    public void DadoElServicio_CuandoEsLlamado_DevuelveListaDeUsuariosExistentes() throws Exception {
        ...
        List<UsuarioEntidad> usuariosEntidad = new ArrayList<>();
        usuariosEntidad.add(new UsuarioEntidad("usuario1","contrasenia1"));
        usuariosEntidad.add(new UsuarioEntidad("usuario2","contrasenia2"));
        usuariosEntidad.add(new UsuarioEntidad("usuario3","contrasenia3"));
        ...
        log.info("Se mockea el servicio que respondera con la respuesta generalk esperada");
    ...
    @Test
    @DisplayName("Actualizar Contrasenia")
    public void DadoElServicioActualizaContrasenia_SiRecibeLosParametrosNecesarios_ActualizaContraseniaDeUsuario() throws Exception {
    ...
    public void DadoElServicioActualizaContrasenia_SiRecibeLosParametrosVacios_RegresaRespuestaGeneralErroneaControlada() throws Exception {
        ...
        String idUsuarioNoExistente = "99999";
        String nuevaContraseniaNoExistente = "XD";
        ...
        log.info("Se mockea el componente que devolvera el valor esperado");
    ...
    public void DadoElServicioObtenerUsuarioPorId_AlIngresarElIdDelUsuario_BuscaEnLaBDLaExistencia() throws Exception {
        ...
        UsuarioEntidad usuarioEntidad = new UsuarioEntidad("usuarioEncontrado","contraseniaEncontrada");
        ...
        log.info("Se arma la peticion como si fuera un postman con la ruta y el parametros de entrada, todo con el resultado esperado");
    ...
    public void DadoElServicioObtenerUsuarioPorId_AlIngresarElIdDelUsuarioNuloOVacio_RegresaNotFoundElServicio() throws Exception {
        ...
        log.info("Se arma la peticion como si fuera un postman con la ruta y el parametro de entrada, todo con el estatus esperado");
    ...
    public void DadoElServicioObtenerUsuarioPorId_AlIngresarElIdDelUsuarioNoExistente_RegresaErrorGeneralControlado() throws Exception {
        ...
        log.info("Se arma la peticion como si fuera un postman con la ruta y el parametro de entrada, todo con el resultado esperado");
    ...
    public void DadoElServicioEliminarUsuarioPorId_AlIngresarUnIdDeUsuarioNuloOVacio_DevuelveNotFoundDelServicio() throws Exception {
        log.info("Se inicializa el parametro esperado con valor nulo o vacio ''");
        // Este servicio responde con NotFound, ya que de inicio no completa la ruta por falta de la pathVariable al ser nulo o ""
        String idUsuario = null;
