...
public class UserControllerIntegracionTest {
    ...
    public void obtenerusuariosControllerTest() throws Exception {
        ...
        listaUsuarios.add(new UsuarioEntidad("usuario1Encontrado", "contrasenia1Encontrada"));
        listaUsuarios.add(new UsuarioEntidad("usuario2Encontrado", "contrasenia2Encontrada"));
        ...
        MvcResult resultadoPeticion = mockMvc.perform(get("/api/obtenerusuarios"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void obtenerUsuarioPorIdControllerTest() throws Exception {
        ...
        MvcResult resultadoPeticion = mockMvc.perform(get("/api/obtenerusuario/{idUsuario}", idUsuario))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void consumirApiPublicaControllerTest() throws Exception {
        ...
        MvcResult resultadoPeticion = mockMvc.perform(get("/api/apipublica/jsonplaceholder"))
                .andExpect(status().isOk())
                .andReturn();
