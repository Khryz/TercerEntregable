package com.wizeline.service.integracion.capas;
...
public class UserServiceTest {
    ...
    public void DadoElServicioLogin_CuandoSeIngresaUsuarioYContrasenia_SeValidaExistenciaEnBdYPasaSiExiste(){
        ...
        UsuarioEntidad usuarioEntidad = new UsuarioEntidad("UsuarioEncontradoBD", "ContraseniaEncontradaBD");
    ...
    public void DadoElServicioActualizaContrasenia_CuandoSeInsertaAlgunParametroNulo_DeberiaTronarConNullPointerException() {
    ...
    public void DadoElServicioObtenerUsuarios_CuandoSeconsumeElServicioSeBuscanUsuariosEnBD_SeRegresaListaDeUsuariosEncontrados(){
        ...
        usuarios.add(new UsuarioEntidad("usuarioMock1","contraseniaMock1"));
        usuarios.add(new UsuarioEntidad("usuarioMock2","contraseniaMock2"));
        usuarios.add(new UsuarioEntidad("usuarioMock3","contraseniaMock3"));
    ...
    public void DadoElServicioObtenerusuarioPorId_CuandoSeIngresaUnId_SeBuscaExistenciaEnBdYRegresaElUsuario(){
        ...
        UsuarioEntidad usuarioEntidad = new UsuarioEntidad("usuarioInventado","contraseniaInventada");
